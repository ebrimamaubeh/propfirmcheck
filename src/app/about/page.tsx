...
export const metadata: Metadata = {
    ...
    description: 'Learn more about Prop Firm Finder and our mission.',
};
        ...
        <>
            ...
            <main className="flex-1 py-12 md:py-20">
                <div className="container max-w-3xl">
                    <Card>
                        <CardHeader>
                            <CardTitle className="text-3xl font-headline">About Prop Firm Finder</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
                            <p>
                                Welcome to Prop Firm Finder, your number one source for discovering and comparing proprietary trading firms. We're dedicated to giving you the very best information, with a focus on reliability, clarity, and usefulness.
                            </p>
                            <p>
                                Founded in {new Date().getFullYear()}, Prop Firm Finder has come a long way from its beginnings. When we first started out, our passion for helping fellow traders find trustworthy funding partners drove us to create this resource, and gave us the impetus to turn hard work and inspiration into a booming online directory.
                            </p>
                            <p>
