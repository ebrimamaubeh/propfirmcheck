...
export const metadata: Metadata = {
    title: 'Disclaimer | Prop Firm Finder',
    description: 'Disclaimer for Prop Firm Finder.',
};
                ...
                <div className="container max-w-3xl">
                    <Card>
                        ...
                        <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
                            <p>The information provided by Prop Firm Finder ("we," "us," or "our") on this website is for general informational purposes only. All information on the site is provided in good faith, however, we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability, or completeness of any information on the site.</p>
